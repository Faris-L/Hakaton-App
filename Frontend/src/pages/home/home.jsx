  ...
  <div className={`home home--${field}`}>
    ...
    <nav className="home__nav">
      ...
      <div className="home__nav-end">
        <button type="button" className="home__nav-btn">
    ...
    <main className="home__main">
      ...
      <div className="home__grid">
        {features.map((f) => (
          <article key={f.id} className={`home-card home-card--${f.id}`} style={{ "--rot": f.rot }}>
            ...
            <div className="home-card__body">
              ...
              <button type="button" className="home-card__btn">{f.cta} →</button>
            </div>
          </article>
        ))}
      </div>
